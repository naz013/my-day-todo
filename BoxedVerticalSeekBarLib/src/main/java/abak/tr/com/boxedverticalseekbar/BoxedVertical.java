...
public class BoxedVertical extends View{
    ...
    private int mValue = mDefaultValue;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            mCornerRadius = a.getInteger(R.styleable.BoxedVertical_cornerRadiusSb, mCornerRadius);
...
//        }
    ...
    public void setValue(int value) {
        Log.d(TAG, "setValue: " + mMax + ", " + mMin + ", " + value);
        value = value > mMax ? mMax : value;
        mValue = value < mMin ? mMin : value;
    }

    private void updateValue(int points) {
        Log.d(TAG, "setValue: " + mMax + ", " + mMin + ", " + points);
        points = points > mMax ? mMax : points;
        points = points < mMin ? mMin : points;
        points = mMax - points;
        //double r = ((double)scrHeight / mMax) * points;

        updateProgress(valueToPixels(points));
        invalidate();
    }

    private int valueToPixels(int value) {
        Log.d(TAG, "valueToPixels: " + scrHeight + ", " + mMax + ", " + value);
        float h = (float) scrHeight / mMax;
        return (int) (h * value);
    }
